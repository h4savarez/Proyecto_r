...
ggplot(monthly, aes(x=date, y=proportion_death, colors= births)) +
geom_line()

```
```{r}
ggplot(monthly, aes(x=date, y= proportion_death)) +
  geom_line() +
...
monthly
ggplot(monthly, aes(x=date , y= log10(proportion_death), color=handwasing_started)) +
  geom_point()+
   labs(title = "Efecto de lavado de manos con relacion a muertes") +
